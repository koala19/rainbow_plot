"""
Name: rainbow_boxplot.py
Author: STDG
Description: Loads data from an .XLXS file or creates random data and plots a seaborn plot in the "husl" pallette
creating a rainbow-like boxplot visualisation with the ability to modify outlier shape, line color, line width ... etc.
"""
...
import colorsys
from load_functions import load_pickle_features_KV, load_pickle_features_Sema_all, load_Pima
...
# *** START OF PROGRAM ***
#data = load_Pima()
#data = load_pickle_features_Sema_all()
...
#sns.boxplot(x="label", y="c_kurt",palette="husl", data=data, saturation=1,flierprops=flierprops, ax=ax)
sns.barplot(palette="husl", data=data, saturation=1, flierprops=flierprops, ax=ax)
